...
if __name__ == "__main__":
    ...
    curs.execute('CREATE VIEW IF NOT EXISTS scores AS SELECT name, rounds, kills, deaths, headshots, max_kill_streak, suicides, f_ratio AS ratio, ROUND(CAST(f_ratio AS REAL) * f_lethality,2) AS score FROM formulas ORDER BY score DESC, max_kill_streak DESC, headshots DESC, suicides ASC, deaths ASC, rounds ASC, name ASC')
